            ...
            <View style={style.userContainerStyle}>
              ...
              <TouchableOpacity
                ...
                <View style={style.thumbnailWrapperStyle}>
                  <CometChatAvatar
                    image={{
                      uri: 'https://data-us.cometchat.io/assets/images/avatars/captainamerica.png',
                    }}
                  />
                </View>
              ...
              <TouchableOpacity
                ...
                <View style={style.thumbnailWrapperStyle}>
                  <CometChatAvatar
                    image={{
                      uri: 'https://data-us.cometchat.io/assets/images/avatars/spiderman.png',
                    }}
                  />
                </View>
              ...
              <TouchableOpacity
                ...
                <View style={style.thumbnailWrapperStyle}>
                  <CometChatAvatar
                    image={{
                      uri: 'https://data-us.cometchat.io/assets/images/avatars/wolverine.png',
                    }}
                  />
                </View>
              ...
              <TouchableOpacity
                ...
                <View style={style.thumbnailWrapperStyle}>
                  <CometChatAvatar
                    image={{
                      uri: 'https://data-us.cometchat.io/assets/images/avatars/cyclops.png',
                    }}
                  />
                </View>
